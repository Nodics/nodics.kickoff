...
/** @description Generated Nodics Kickoff documentation search metadata. */
module.exports = {
  "record0": {
    "code": "kickoffDocsSearchproductkickoffdocumentationproduct",
    "product": "kickoffDocumentationProduct",
    "targetType": "PRODUCT",
    "targetCode": "kickoffDocumentationProduct",
    "title": "Nodics Kickoff Documentation",
    "summary": "Project-owned documentation for the reference customer workspace, local setup, publication, qualification, customization, and functional journeys.",
    "searchText": "Nodics Kickoff Documentation Project-owned documentation for the reference customer workspace, local setup, publication, qualification, customization, and functional journeys.",
    "keywords": [
      "kickoff",
      "documentation",
      "customer project"
  ...
  "record1": {
    "code": "kickoffDocsSearchnavigationkickoffdocumentationnavigationtree",
    "product": "kickoffDocumentationProduct",
    "targetType": "NAVIGATION",
    "targetCode": "kickoffDocumentationNavigationTree",
    "title": "Nodics Kickoff Documentation Navigation",
    "summary": "Search setup, runtime, modules, and customization",
    "searchText": "Nodics Kickoff Documentation Navigation Search Kickoff documentation Search setup, runtime, modules, and customization",
    "keywords": [
      "navigation",
      "hierarchy",
      "expandable",
  ...
  "record2": {
    "code": "kickoffDocsSearchnodekickoffdocsnoderoot",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    "targetCode": "kickoffDocsNodeRoot",
    "title": "Nodics Kickoff Documentation",
    "summary": "Root node for customer project documentation rendered through backend-owned, Axis-manageable content-catalog records.",
    "searchText": "Nodics Kickoff Documentation Root node for customer project documentation rendered through backend-owned, Axis-manageable content-catalog records. kickoff customer project documentation",
    "keywords": [
      "kickoff",
      "customer project",
      "documentation"
  ...
  "record3": {
    "code": "kickoffDocsSearchnodekickoffdocsnodesecdiscoverkickoff",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Discover Kickoff Project identity, ownership boundaries, and the business reason Kickoff exists as a reference customer workspace. discover-kickoff Discover Kickoff",
    "keywords": [
      "discover-kickoff",
      "Discover Kickoff"
    ],
  ...
  "record4": {
    "code": "kickoffDocsSearchnodekickoffdocsnodesecrunkickofflocally",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Run Kickoff Locally Local runtime topology, start sequence, acceptance checks, and developer/operator verification for the reference stack. run-kickoff-locally Run Kickoff Locally",
    "keywords": [
      "run-kickoff-locally",
      "Run Kickoff Locally"
    ],
  ...
  "record5": {
    "code": "kickoffDocsSearchnodekickoffdocsnodesecpublishandqualify",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Publish and Qualify Local publishing operations, deployment qualification evidence, recovery rules, and production-boundary discipline. publish-and-qualify Publish and Qualify",
    "keywords": [
      "publish-and-qualify",
      "Publish and Qualify"
    ],
  ...
  "record6": {
    "code": "kickoffDocsSearchnodekickoffdocsnodeseccustomizecustomerprojects",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Customize Customer Projects Project-layer customization examples, configuration-first decisions, documentation placement, and rollback-safe extension guidance. customize-customer-projects Customize Customer Projects",
    "keywords": [
  ...
  "record7": {
    "code": "kickoffDocsSearchnodekickoffdocsnodesecfunctionaljourneys",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Functional Journeys Commerce, Engagement, provider, privacy, reversal, and operator journeys demonstrated by the reference customer project. functional-journeys Functional Journeys",
    "keywords": [
      "functional-journeys",
      "Functional Journeys"
    ],
  ...
  "record8": {
    "code": "kickoffDocsSearchnodekickoffdocsnodegrpdiscoverkickoffprojectidentityandownership",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    "targetCode": "kickoffDocsNodeGrpdiscoverKickoffprojectIdentityAndOwnership",
    "title": "Project Identity and Ownership",
    "summary": "Business-friendly group for Project Identity and Ownership topics.",
    "searchText": "Project Identity and Ownership Business-friendly group for Project Identity and Ownership topics. kickoff reference project customer project documentation",
    "keywords": [
      "kickoff",
      "reference project",
      "customer project",
  ...
  "record9": {
    "code": "kickoffDocsSearchnodekickoffdocsnodetopickickoffoverview",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Kickoff project overview Understand what Nodics Kickoff owns, how it demonstrates the framework, and where project-owned documentation belongs. kickoff reference project customer project documentation",
    "keywords": [
      "kickoff",
      "reference project",
      "customer project",
  ...
  "record10": {
    "code": "kickoffDocsSearchnodekickoffdocsnodegrprunkickofflocallyruntimetopology",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    "targetCode": "kickoffDocsNodeGrprunKickoffLocallyruntimeTopology",
    "title": "Runtime Topology",
    "summary": "Business-friendly group for Runtime Topology topics.",
    "searchText": "Runtime Topology Business-friendly group for Runtime Topology topics. local runtime topology start servers",
    "keywords": [
      "local runtime",
      "topology",
      "start",
  ...
  "record11": {
    "code": "kickoffDocsSearchnodekickoffdocsnodetopickickofflocalruntime",
    "product": "kickoffDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Local runtime topology Start and reason about the local Platform, WCMS, and Process servers that make the reference project usable. local runtime topology start servers",
    "keywords": [
      "local runtime",
      "topology",
      "start",
  ...
  "record13": {
    ...
    "summary": "Business-friendly group for Acceptance and Verification topics.",
    "searchText": "Acceptance and Verification Business-friendly group for Acceptance and Verification topics. acceptance fresh local verification checklist",
    "keywords": [
      "acceptance",
      "fresh local",
      "verification",
  ...
  "record14": {
    ...
    "searchText": "Local acceptance checklist Run a fresh local database bootstrap and verify Platform, WCMS, Cron, Axis, documentation, media, and module lifecycle behavior. acceptance fresh local verification checklist",
    "keywords": [
      "acceptance",
      "fresh local",
      "verification",
  ...
  "record15": {
    ...
    "summary": "Business-friendly group for Publishing Operations topics.",
    "searchText": "Publishing Operations Business-friendly group for Publishing Operations topics. publishing staged online recovery",
    "keywords": [
      "publishing",
      "staged",
      "online",
  ...
  "record16": {
    ...
    "searchText": "Local publishing operations Operate, diagnose, recover, upgrade, retain, and qualify the Local Staged-to-Online publishing lifecycle without direct database access. publishing staged online recovery",
    "keywords": [
      "publishing",
      "staged",
      "online",
  ...
  "record17": {
    ...
    "summary": "Business-friendly group for Deployment Qualification topics.",
    "searchText": "Deployment Qualification Business-friendly group for Deployment Qualification topics. deployment qualification evidence production",
    "keywords": [
      "deployment",
      "qualification",
      "evidence",
  ...
  "record18": {
    ...
    "searchText": "Deployment qualification Run the governed local evidence pack and coordinate production-only load, resilience, security, provider, recovery, and accessibility sign-off. deployment qualification evidence production",
    "keywords": [
      "deployment",
      "qualification",
      "evidence",
  ...
  "record19": {
    ...
    "summary": "Business-friendly group for Project Customization topics.",
    "searchText": "Project Customization Business-friendly group for Project Customization topics. customization project module overlay configuration",
    "keywords": [
      "customization",
      "project module",
      "overlay",
  ...
  "record20": {
    ...
    "searchText": "Customer customization guide Use Kickoff as a safe example for project modules, environment configuration, and customer overlays. customization project module overlay configuration",
    "keywords": [
      "customization",
      "project module",
      "overlay",
  ...
  "record21": {
    ...
    "summary": "Business-friendly group for Commerce and Engagement Journeys topics.",
    "searchText": "Commerce and Engagement Journeys Business-friendly group for Commerce and Engagement Journeys topics. commerce engagement customer journey provider",
    "keywords": [
      "commerce",
      "engagement",
      "customer journey",
  ...
  "record22": {
    ...
    "searchText": "Commerce and Engagement functional journeys Follow the local customer, operator, visibility, reversal, recovery, privacy, and provider-sandbox journeys with clear ownership and verification evidence. commerce engagement customer journey provider",
    "keywords": [
      "commerce",
      "engagement",
      "customer journey",
  ...
  "record23": {
    ...
    "searchText": "Nodics Kickoff Documentation Landing content for the Kickoff customer-reference documentation catalogue, including setup, runtime, publication, qualification, customization, and functional journeys.",
    "keywords": [
      "PRODUCT",
      "kickoffDocumentationProduct",
      "Nodics Kickoff Documentation"
    ],
    "facets": {
      "ownerType": "PRODUCT",
  ...
  "record24": {
    ...
    "title": "Discover Kickoff",
    "summary": "Project identity, ownership boundaries, and the business reason Kickoff exists as a reference customer workspace.",
    "searchText": "Discover Kickoff Project identity, ownership boundaries, and the business reason Kickoff exists as a reference customer workspace.",
    "keywords": [
      "SECTION",
      "kickoffDocsNodeSecdiscoverKickoff",
      "Discover Kickoff"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record25": {
    ...
    "title": "Run Kickoff Locally",
    "summary": "Local runtime topology, start sequence, acceptance checks, and developer/operator verification for the reference stack.",
    "searchText": "Run Kickoff Locally Local runtime topology, start sequence, acceptance checks, and developer/operator verification for the reference stack.",
    "keywords": [
      "SECTION",
      "kickoffDocsNodeSecrunKickoffLocally",
      "Run Kickoff Locally"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record26": {
    ...
    "title": "Publish and Qualify",
    "summary": "Local publishing operations, deployment qualification evidence, recovery rules, and production-boundary discipline.",
    "searchText": "Publish and Qualify Local publishing operations, deployment qualification evidence, recovery rules, and production-boundary discipline.",
    "keywords": [
      "SECTION",
      "kickoffDocsNodeSecpublishAndQualify",
      "Publish and Qualify"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record27": {
    ...
    "title": "Customize Customer Projects",
    "summary": "Project-layer customization examples, configuration-first decisions, documentation placement, and rollback-safe extension guidance.",
    "searchText": "Customize Customer Projects Project-layer customization examples, configuration-first decisions, documentation placement, and rollback-safe extension guidance.",
    "keywords": [
      "SECTION",
      "kickoffDocsNodeSeccustomizeCustomerProjects",
      "Customize Customer Projects"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record28": {
    ...
    "title": "Functional Journeys",
    "summary": "Commerce, Engagement, provider, privacy, reversal, and operator journeys demonstrated by the reference customer project.",
    "searchText": "Functional Journeys Commerce, Engagement, provider, privacy, reversal, and operator journeys demonstrated by the reference customer project.",
    "keywords": [
      "SECTION",
      "kickoffDocsNodeSecfunctionalJourneys",
      "Functional Journeys"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record29": {
    ...
    "searchText": "Project Identity and Ownership Detailed landing content for Project Identity and Ownership, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrpdiscoverKickoffprojectIdentityAndOwnership",
  ...
  "record30": {
    ...
    "searchText": "Runtime Topology Detailed landing content for Runtime Topology, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrprunKickoffLocallyruntimeTopology",
      "Runtime Topology"
    ],
    "facets": {
      "ownerType": "GROUP",
  ...
  "record31": {
    ...
    "searchText": "Acceptance and Verification Detailed landing content for Acceptance and Verification, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrprunKickoffLocallyacceptanceAndVerification",
  ...
  "record32": {
    ...
    "searchText": "Publishing Operations Detailed landing content for Publishing Operations, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrppublishAndQualifypublishingOperations",
  ...
  "record33": {
    ...
    "searchText": "Deployment Qualification Detailed landing content for Deployment Qualification, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrppublishAndQualifydeploymentQualification",
  ...
  "record34": {
    ...
    "searchText": "Project Customization Detailed landing content for Project Customization, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrpcustomizeCustomerProjectsprojectCustomization",
  ...
  "record35": {
    ...
    "searchText": "Commerce and Engagement Journeys Detailed landing content for Commerce and Engagement Journeys, including business purpose, customization behavior, and validation evidence.",
    "keywords": [
      "GROUP",
      "kickoffDocsNodeGrpfunctionalJourneyscommerceAndEngagementJourneys",
      "Commerce and Engagement Journeys"
    ],
    "facets": {
      "ownerType": "GROUP",
