  ...
  "record1": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 2161,
        "checksum": "e9ffcfc4c880702510f167766e0feb48c5b1793977ba3ab5b20f6ee10b2c57d3"
      }
    },
    "active": true
  },
  "record2": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 2076,
        "checksum": "5735760abac6b82050190d7f23d74582e858f2a1dd375a44e4208b24a750af55"
      }
    },
    "active": true
  },
  "record3": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 2608,
        "checksum": "9bcb682548b84998b5af336c91c663687ca26c7a351fde4aad3d166485ee48e7"
      }
    },
    "active": true
  },
  "record4": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "This layout is only a convenience. Customer projects may live anywhere. The important contract is that the project dependency graph and layered configuration identify the framework checkout and runtime values without a project-owned `.env` file."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        },
        {
          "kind": "ordered-list",
          "items": [
            "Kickoff package dependencies resolve to the intended framework checkout.",
            "Frontend applications point to the local Platform server through their existing application configuration mechanism."
          ]
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 3203,
        "checksum": "a83f2885cdfdee04b5bfd93b0aa00c8f26964de7783611c76803e6f79ff23312"
      }
    },
    "active": true
  },
  ...
  "record6": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "The runner implementation belongs to framework tooling. The root `package.json.name` owns stable project identity. Do not create `nodics.project.json`; tooling discovers command aliases from environment server metadata and conventional acceptance scripts. Thin command aliases and human-readable project metadata live in `package.json`. Domain selections and qualification profile facts live beside the environment, for example `envs/kickoffDockerLocal/nodics.environment.json`. Data packs are owned by module data manifests. Runtime server startup facts stay with the selected environment server packages. A generated customer project should reuse the framework runner through project commands and change only its project-owned facts while retaining the safety properties:"
        },
        {
          "kind": "unordered-list",
          "items": [
      ...
      "source": {
        ...
        "wordCount": 1242,
        "checksum": "5880d9e587b11e4ec1c7b53bd5ed3131e5677e506b8ed5cc91f8ed30015009d4"
      }
    },
    "active": true
  },
  "record7": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 2214,
        "checksum": "2b3b07f4b76b95968cfad324a264d5254a9380300a2e93c71345b08dd9d52d66"
      }
    },
    "active": true
  },
  "record8": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "The framework supplies shared tooling operations. This project's server aliases are discovered from `envs/*` server metadata, and application-specific scripts are discovered from conventional files under `scripts/acceptance`. For example, `acceptance:agora-commerce` launches the project-owned customer journey through the shared executor. Moving ownership does not authorize executing that journey: its existing credential, import, startup and destructive confirmation gates apply."
        },
        {
          "kind": "paragraph",
        ...
        {
          "kind": "paragraph",
          "text": "All ten Local runtimes retain independent generic `NODICS_*_API_KEY` bindings and runtime instance identities. The binding names are environment-neutral; the Local layer only supplies the selected value and keeps a compatibility fallback for older developer machines. These are intentional deployment selections. Missing retained proof remains null; there is no fallback to a sample key or human administrator. Profile owns runtime scope grants, tenant/enterprise validation, token issuance, renewal and revocation."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 3250,
        "checksum": "583bf985f78a542cf66076f46002ad8a6dd48d0d7976f31ca95d3dea4e6cfaf7"
      }
    },
    "active": true
  },
