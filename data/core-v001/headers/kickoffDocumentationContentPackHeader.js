...
module.exports = {
  cms: {
    ...
    kickoffDocumentationLegacyNavigationCleanupData: { options: { enabled: true, schemaName: 'cmsDocumentationNode', operation: 'remove', dataFilePrefix: 'kickoffDocumentationLegacyNavigationCleanupData' }, query: { product: 'kickoffDocumentationProduct', navigation: 'kickoffDocumentationNavigationTree', nodeLevel: { $in: ['GROUP', 'SUBGROUP', 'TOPIC'] } } },
