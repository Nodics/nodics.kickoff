  ...
  "record1": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              ...
              "Yes. Kickoff provides ready local Platform, WCMS, Cron, and Axis wiring."
            ],
            [
        ...
        {
          "kind": "paragraph",
          "text": "Verify Kickoff as a reference customer project by proving that it can run the framework without becoming framework source. The local proof is to configure the framework root, install dependencies, start Platform, WCMS, and Cron when needed, start Axis, log in, import required data releases, and open the Kickoff documentation product. The project should contribute its own docs and sample behavior while framework docs still come from `nodics.docs` and Axis product docs still come from the Platform Axis backend module."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 1608,
        "checksum": "07028f0f8e3c534b523f3e42af4bb491c93555065f72f66255a4bdb7f4b7a12e"
      }
    },
    "active": true
  },
  "record2": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Treating Cron as mandatory just because the reference workspace can start a Cron server.",
        ...
        {
          "kind": "paragraph",
          "text": "Verify local runtime topology by starting each server from the customer project, not from framework internals. Platform should expose login, BackOffice bootstrap, registry, and API discovery. WCMS should expose content, documentation, media, and import/export delivery. Cron should report optional runtime availability when it is running. Axis should connect through Platform and WCMS instead of local hardcoded module state."
        },
        {
          "kind": "paragraph",
          "text": "For a beginner-friendly proof, open Axis after the servers start and inspect Dashboard, System and Integrations, Module Registry, Imports and Exports, Content and Experience, Media, Cron where active, and Documentation. The UI should explain the same topology that the server configuration declares."
        },
        {
          "kind": "heading",
          "level": 2,
      ...
      "source": {
        ...
        "wordCount": 1008,
        "checksum": "c8df06b59cbeaef603393425a5a34dd05573c94b66b9128f6a6bbe31d3f49c13"
      }
    },
    "active": true
  },
  "record3": {
    ...
    "properties": {
      ...
      "headings": [
        ...
        {
          "text": "Common mistakes",
          "anchor": "kickoffLocalAcceptance-18-common-mistakes",
          "level": 2
        },
        {
          "text": "Verification",
          "anchor": "kickoffLocalAcceptance-19-verification",
          "level": 2
        }
      ],
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Verifying only Platform while forgetting WCMS, documentation, media, Cron, and Axis routes."
          ]
        },
        {
          "kind": "heading",
      ...
      "source": {
        ...
        "wordCount": 2008,
        "checksum": "5a4206dafe821e94caed93a93503631356222145583605903a5032aae04e67b3"
      }
    },
    "active": true
  },
  "record4": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 1987,
        "checksum": "c2c4bfabcdda29b2a9643ed3a7984823939bd28609ae33396c7e352a10a72cda"
      }
    },
    "active": true
  }
