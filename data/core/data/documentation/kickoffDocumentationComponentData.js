  ...
  "record1": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "Think of `nodics.ai` as the factory equipment, `nodics.kickoff` as the sample production line, `nodics.exp` as the frontend workspace shelf, and Axis, Nexus, and Agora as separate customer-facing screens. The factory equipment provides standard capabilities such as Core, Platform, WCMS, Media, Cron, Process, Commerce, and Engagement. The sample production line decides which equipment to connect for a local demonstration. The screens connect to the running backend and show only the capabilities that the backend says are available and authorized."
        },
        {
          "kind": "paragraph",
        ...
        },
        {
          ...
          "items": [
            "how a customer project depends on Nodics framework packages;",
            "how environment and server modules load after standard functional modules;",
            "how Platform, WCMS Staged, WCMS Online, Process/Cron, Engagement, and Commerce can run as separate ownership domains while serving three frontends;",
        ...
        },
        {
          ...
          "items": [
            ...
            "`nodics.project.json` declares framework-owned project commands, runtime startup facts, topology facts, and acceptance facts;",
            "`config/` contains project-level defaults;",
            "`envs/kickoffLocal/` contains local environment and server composition;",
            "`modules/` contains project-owned modules and customization examples;",
            "`docs/` contains authored Kickoff-wide documentation;",
        ...
        },
        {
          ...
          "items": [
            ...
            "Do not copy `nodics.foundation`, `nodics.platform`, `nodics.wcms`, or `nodics.cron` source into this repository.",
            "Do not move Axis renderers or browser code into Kickoff.",
        ...
        {
          "kind": "paragraph",
          "text": "Verify Kickoff as a reference customer project by proving that it can run the framework without becoming framework source. The local proof is to configure the framework root, install dependencies, start the six backend runtimes plus Axis, Nexus, and Agora, log in, import required data releases, open the Kickoff documentation product, and verify Agora's multi-domain storefront. The project should contribute its own docs and sample behavior while framework docs still come from `nodics.docs` and Axis product docs still come from the Platform Axis backend module."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 1686,
        "checksum": "110c8d834b4a1704519323a07000f80e6384953e2e8df5f5ae479ec9a263eff1"
      }
    },
    "active": true
  },
  "record2": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "The governed supervisor starts all three frontends with the six backends:"
        },
        {
          "kind": "code",
          "language": "bash",
        ...
        {
          "kind": "paragraph",
          "text": "If npm cannot install framework packages, check `NODICS_FRAMEWORK_ROOT`, rerun `npm run configure:framework`, and confirm the configured directory contains `nodics.foundation`, `nodics.platform`, `nodics.wcms`, and any optional framework modules used by the local server."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "The final pre-Builder gate must use a fresh Local database and qualify all nine runtimes together: Platform, WCMS Staged, WCMS Online, Process, Engagement, Commerce, Axis, Nexus, and Agora. Verify the topology from the customer project, not from framework internals. Platform should expose login, BackOffice bootstrap, registry, and API discovery. WCMS should expose content, documentation, media, and import/export delivery. Process and Automation should report Process and optional Cron runtime availability from the composed server. Axis should connect through Platform and WCMS instead of local hardcoded module state."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 1222,
        "checksum": "d17cb69afee347728d360c269b67a31907bebb66f4506a167d8617f98880c0e5"
      }
    },
    "active": true
  },
  "record3": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "No contributor, AI agent, test, migration, or acceptance script may read or mutate Nodics databases directly. A fresh-schema run is therefore blocked until Platform provides a secured, bounded Local reset API/service with authorization, audit, explicit runtime targets, and recovery evidence. Never substitute a database shell command."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "This checks the running or newly started split WCMS topology and imports missing releases only through Nodics APIs. `acceptance:local:fresh` deliberately fails closed until the governed reset capability exists."
        },
        {
          "kind": "heading",
          "level": 3,
        ...
        {
          "kind": "paragraph",
          "text": "To include the separate Axis and Nexus frontend repositories:"
        },
        {
          "kind": "code",
          "language": "bash",
        ...
        {
          "kind": "paragraph",
          "text": "Run the API-only checklist repeatedly when confidence matters. The expected result is idempotent release qualification, mandatory module visibility, optional Cron lifecycle handling, and Axis rendering without manual database inspection or edits. Fresh-schema proof resumes only after the governed reset API/service is implemented."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 2386,
        "checksum": "430c636ee8b9949fcf466996a400c0077eebd700e68e51b6bfcf2547d058bdd9"
      }
    },
    "active": true
  },
  "record4": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 1317,
        "checksum": "d4498c4beced77d755d62f2c1cea8da326d37347a50e9084d3515581ec568028"
      }
    },
    "active": true
  },
  "record5": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "The runner implementation belongs to framework tooling. The project owns only the qualification facts exposed through `nodics.project.json`: repository coordinates, environment identity, local gate choices, and evidence policy. A generated customer project should reuse the framework runner through project commands and change only its manifest facts while retaining the safety properties:"
        },
        {
          "kind": "unordered-list",
          "items": [
      ...
      "source": {
        ...
        "wordCount": 1091,
        "checksum": "ca2785a817afb19cbec312052ac1ee30c0019c0f7cc785fcf69876cf0847a3bf"
      }
    },
    "active": true
  },
  "record6": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 1975,
        "checksum": "a1a72544f183bc94376860f271097cd1313bce69a56daec594400a9bea7df766"
      }
    },
    "active": true
  },
  "record7": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "Install the workspace dependencies and use Kickoff project commands rather than constructing an undocumented module graph. Run `npm run start:platform` first, then the Commerce and Engagement start commands in separate terminals. The command aliases execute framework-owned runtime startup tooling using facts from `nodics.project.json`. Readiness must pass before invoking a journey. Do not place provider credentials in source, sample data, browser storage, or documentation. Environment-specific secret references belong in secured layered configuration."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 1377,
        "checksum": "730c4a38e6cbce88f8d03f0bf8543cdf8dba276e77df586b60b2cb23c4e5907f"
      }
    },
    "active": true
  }
