  ...
  "record1": {
    ...
    "properties": {
      ...
      "source": {
        ...
        "wordCount": 1693,
        "checksum": "594aabd5305c6f79df38865cdce5c12992749f6a7cc149dce47bbd6acb36e327"
      }
    },
    "active": true
  },
  "record2": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "The final pre-Builder gate must use a fresh Local database and qualify all nine runtimes together: Platform, WCMS Staged, WCMS Online, Process, Engagement, Commerce, Axis, Nexus, and Agora. Verify the topology from the customer project, not from framework internals. Platform should expose login, BackOffice bootstrap, registry, and API discovery. WCMS should expose content, documentation, media, and import/export delivery. Process and Automation should report Process runtime availability with workflow and cronjob technical modules from the composed server. Axis should connect through Platform and WCMS instead of local hardcoded module state."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "wordCount": 1224,
        "checksum": "b040e8a6267834ccf5d64a9275e1bbcbdeec33c8518787312731b5ada062c377"
      }
    },
    "active": true
  },
    ...
    "properties": {
      ...
      "blocks": [
        ...
        },
        {
          "kind": "unordered-list",
          "items": [
            "If Process and Automation is running, Axis can observe both `nodics.process` and `nodics.process` from the same runtime.",
            "If Cron is not registered, it appears as available to register.",
            "Register moves it into the registered list without requiring a page refresh.",
            "Activate changes lifecycle state without freezing buttons.",
            "Deactivate and deregister return it to the correct next state."
      ...
      "source": {
        ...
        "wordCount": 2389,
        "checksum": "644ce345884dddd329004db6218b0d301d2cab4cbb7ef380c99289b29025bfff"
      }
    },
    "active": true
  },
