...
/**
 * @module modules/agora.apparel/modules/agoraApparel/data/staged/apparel/data/agoraApparelSharedComponentData
...
module.exports = {
  ...
  record42: {
    ...
    properties: {
      ...
      gates: [
        { code: 'MEDIA_RIGHTS', owner: 'nMedia + agoraApparel', status: 'RELEASE_GATE' },
