...
module.exports = {
  record0: {
    ...
    properties: {
      ...
      summary:
        "Browse live apparel products with editorial merchandising, filters, sorting, variants, price, media, and availability.",
  ...
  record1: {
    ...
    properties: {
      ...
      summary:
        "A curated arrival story for shoppers landing from New in, powered by the same product listing search results.",
  ...
  record2: {
    ...
    properties: {
      ...
      summary:
        "Category-aware merchandising for clothing pages while products remain resolved from indexed Commerce data.",
  ...
  record3: {
    ...
    properties: {
      ...
      summary:
        "Choose a category, brand-inspired edit, or seasonal collection. Each tile opens a live Commerce listing with backend-driven products and media.",
