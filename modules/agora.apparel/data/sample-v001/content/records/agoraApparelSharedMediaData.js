...
/**
 * @module modules/agora.apparel/data/sample-v001/content/records/agoraApparelSharedMediaData
 * @description Defines Agora Apparel media records that hydrate release-owned assets into WCMS Staged media storage.
 * @layer data
 * @owner agora.apparel
