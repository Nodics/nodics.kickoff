...
module.exports = {
  ...
  media: {
    ...
    sharedMediaReferences: entry(
      "mediaReference",
      "agoraElectronicsSharedMediaReferenceData",
  ...
  cms: {
    ...
    sharedRenderers: entry(
      "cmsTypeCode2Renderer",
      "agoraElectronicsSharedRendererData",
    ),
    renderers: entry("cmsTypeCode2Renderer", "agoraElectronicsRendererData"),
    sharedComponentGroups: entry(
      "cmsComponentTypeGroup",
      "agoraElectronicsSharedComponentTypeGroupData",
    ),
    sharedSlots: entry("cmsSlotDefinition", "agoraElectronicsSharedSlotData"),
    sharedTemplates: entry(
      "cmsPageTemplate",
      "agoraElectronicsSharedTemplateData",
    ),
    sites: entry("cmsSite", "agoraElectronicsSiteData"),
    sharedComponents: entry(
      "cmsComponent",
      "agoraElectronicsSharedComponentData",
    ),
    sharedComponentMedia: entry(
      "cmsComponentMedia",
      "agoraElectronicsSharedComponentMediaData",
      { componentMediaCode: "$componentMediaCode" },
    ),
