...
/**
 * @module modules/agora.electronics/data/sample-v001/content/records/agoraElectronicsSharedComponentTypeGroupData
...
module.exports = {
  record0: {
    ...
    description:
      "Allowlisted Home, listing, search, PDP, cart, checkout, order and lifecycle composition components rendered by nodics.agora.",
    componentTypeCodes: [
      "agoraHeaderType",
      "agoraFooterType",
      "agoraHeroBannerType",
