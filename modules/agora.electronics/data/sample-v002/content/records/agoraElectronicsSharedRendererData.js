...
/**
 * @module modules/agora.electronics/data/sample-v001/content/records/agoraElectronicsSharedRendererData
...
module.exports = {
  ...
  record2: {
    code: "agoraProductDetailPageType",
  ...
  record5: {
    code: "agoraOrderConfirmationPageType",
  ...
  record6: {
    code: "agoraOrderHistoryPageType",
  ...
  record17: {
    code: "agoraOrderConfirmationType",
  ...
  record27: {
    code: "agoraServicePromiseGridType",
  ...
  record30: {
    code: "agoraSpecialOfferSplitType",
