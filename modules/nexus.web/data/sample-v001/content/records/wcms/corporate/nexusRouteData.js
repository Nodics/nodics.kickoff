...
module.exports = {
  ...
  record27: {
    code: "nexusProductWasteRoute",
    path: "/products/waste-management",
    page: "nexusProductWastePage",
    site: "nexusCorporateSite",
    locale: "en",
    channel: "web",
    routeType: "PAGE",
  ...
  record28: {
    code: "nexusProductApparelRoute",
    path: "/products/agora-apparel",
    page: "nexusProductApparelPage",
    site: "nexusCorporateSite",
    locale: "en",
    channel: "web",
    routeType: "PAGE",
  ...
  record29: {
    code: "nexusProductElectronicsRoute",
    path: "/products/agora-electronics",
    page: "nexusProductElectronicsPage",
    site: "nexusCorporateSite",
    locale: "en",
    channel: "web",
    routeType: "PAGE",
  ...
  record30: {
    code: "nexusProductTelcoRoute",
    path: "/products/agora-telco",
    page: "nexusProductTelcoPage",
    site: "nexusCorporateSite",
    locale: "en",
    channel: "web",
    routeType: "PAGE",
  ...
  record31: {
    code: "nexusSolutionsRoute",
    path: "/solutions",
    page: "nexusSolutionsPage",
    site: "nexusCorporateSite",
    locale: "en",
    channel: "web",
    routeType: "PAGE",
