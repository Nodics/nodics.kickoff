...
/**
 * @module modules/agora.telco/modules/agoraTelco/data/staged/telco/data/agoraTelcoSharedComponentData
...
module.exports = {
  ...
  record42: {
    ...
    properties: {
      ...
      gates: [
        { code: 'MEDIA_RIGHTS', owner: 'nMedia + agoraTelco', status: 'RELEASE_GATE' },
