...
/**
 * @module modules/agora.telco/data/sample-v001/content/records/agoraTelcoSharedMediaData
 * @description Defines Agora Telco media records that hydrate release-owned assets into WCMS Staged media storage.
 * @layer data
 * @owner agora.telco
