...
/**
 * @module modules/agora.telco/data/sample-v001/content/headers/agoraTelcoContentHeader
...
module.exports = {
  ...
  media: {
    sharedMedia: entry("media", "agoraTelcoSharedMediaData"),
    sharedMediaReferences: entry(
      "mediaReference",
      "agoraTelcoSharedMediaReferenceData",
  ...
  cms: {
    ...
    sharedComponentMedia: entry(
      "cmsComponentMedia",
      "agoraTelcoSharedComponentMediaData",
