...
module.exports = {
      ...
      slides: [
        {
          ...
          eyebrow: "Connected Plans 2026",
          title: "Flexible plans for always-on customers.",
          primaryAction: {
        ...
        },
        {
          ...
          eyebrow: "Bundle Data, Voice & Devices",
          title: "Plans, devices and bundles for every connection.",
          primaryAction: {
            label: "Shop New",
            collectionCode: "agoraNewArrivals",
          },
    ...
    properties: {
      ...
      items: [
        ...
        },
        {
          collectionCode: "agoraTelcoPostpaid",
          label: "Postpaid",
          summary: "Unlimited and family connectivity",
          mediaCode: "agora-owned-telco-flexi-prepaid-v1",
        },
        {
          collectionCode: "agoraTelcoPrepaid",
          label: "Prepaid",
          summary: "Flexible prepaid bundles",
          mediaCode: "agora-owned-telco-unlimited-postpaid-v1",
        },
        {
          collectionCode: "agoraTelcoDevices",
          label: "Devices",
          summary: "Phones, routers and accessories",
          mediaCode: "agora-owned-telco-flexi-prepaid-v1",
        },
        {
  ...
  record34: {
    ...
    properties: {
      items: [
        {
          title: "Plan Bundles",
          summary: "Activation-week offers",
          mediaCode: "agora-owned-telco-flexi-prepaid-v1",
          variant: "copy-left",
          action: {
  ...
  record38: {
    ...
    properties: {
      ...
      summary:
        "Our customers love the quality, service and carefully selected plans and devices.",
      items: [
        {
          mediaCode: "agora-owned-telco-unlimited-postpaid-v1",
          ...
          product: "Unlimited Postpaid Plan",
        },
        {
          mediaCode: "agora-owned-telco-flexi-prepaid-v1",
  ...
  record43: {
    ...
    properties: {
      summary:
        "Nodics Agora brings telco commerce into the Nodics experience layer with secure checkout, catalog discovery, and customer self-service.",
      contactEmail: "nodics.framework@gmail.com",
      groups: [
        {
          title: "Commerce",
          links: ["New plans", "Postpaid", "Prepaid", "Devices & Accessories"],
        },
        {
          title: "Customer Care",
