...
/**
 * @module modules/agora.common/modules/agoraCommonData/data/staged/pricing/headers/agoraPricingHeader
...
/** @description Core import header for the Nodics Agora Pricing source release. */
...
module.exports = {
  pricing: {
    agoraPriceBookData: entry('priceBook', 'agoraPriceBookData'),
    agoraPriceRowData: entry('priceRow', 'agoraPriceRowData')
  }
};
