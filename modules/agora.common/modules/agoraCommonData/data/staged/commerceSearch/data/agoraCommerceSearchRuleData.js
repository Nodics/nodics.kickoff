...
/**
 * @module modules/agora.common/modules/agoraCommonData/data/staged/commerceSearch/data/agoraCommerceSearchRuleData
...
module.exports = {
  record0: {
    ...
    priority: 100,
    revision: 1,
    evidence: { source: 'agoraCommonData', intent: 'Demonstrate business-controlled category ranking for Product discovery.' },
    active: true
  }
};
