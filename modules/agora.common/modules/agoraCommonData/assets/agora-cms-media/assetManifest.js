...
/**
 * @module modules/agora.common/modules/agoraCommonData/assets/agora-cms-media/assetManifest
 * @description Declares project-owned Agora media assets that must be uploaded to WCMS Staged before CMS publication.
 * @layer assets
