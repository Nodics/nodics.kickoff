...
`agoraCommonData` is the Nodics Kickoff project content-pack module for the Nodics
...
```text
agoraCommonData files -> Commerce/WCMS Staged schemas -> publication to Online
