# Docker Local Loyalty Server

Docker Local Loyalty Server runtime composition and configuration boundary for Nodics Kickoff.
...
After changes, run the nearest focused test or the Kickoff structure and Docker Local runtime preparation checks from the project root.
