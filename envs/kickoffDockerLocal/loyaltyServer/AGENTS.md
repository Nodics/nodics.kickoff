# Docker Local Loyalty Server Agent Contract
...
- Keep reusable Loyalty behavior in `nodics.loyalty`; this server owns only Docker Local runtime composition, data-release destination policy, database selection, endpoint coordinates, and server-local guidance.
