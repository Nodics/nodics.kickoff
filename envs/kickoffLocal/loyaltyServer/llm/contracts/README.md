# Loyalty Server Contracts

This folder contains maintained AI/developer contracts for the Loyalty Server boundary. Keep this README concise and put only durable module-specific rules here.
