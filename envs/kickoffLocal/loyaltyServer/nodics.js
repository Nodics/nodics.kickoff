...
/** @module kickoffLocal/loyaltyServer @description Declares the reference customer Loyalty server lifecycle. @layer environment-server @owner nodics.kickoff @override Customer projects own their topology. */
module.exports = {
    /**
