...
module.exports = {
    ...
    activeModules: {
        groups: [],
        modules: ['cmsStaged', 'nodics.kickoff', 'kickoffCore', 'kickoffApi', 'kickoffInt', 'nexusWebData', 'partnerSiteData', ...agoraDomains.projectPacks,
    ...
    cms: { publication: {
        ...
        nexusprofessionalcopy: { releaseCode: 'nexusWebData:nexusCorporateProfessionalCopyUpdate', releaseVersion: '0.0.0',
            dataType: 'core', rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        agora: { releaseCode: 'agoraApparel:agoraApparelContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
            rootType: 'site', rootCode: 'agoraStorefrontSite', sourceVersion: '0' },
        agoraapparel: { releaseCode: 'agoraApparel:agoraApparelContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
            rootType: 'site', rootCode: 'agoraApparelSite', sourceVersion: '0' },
        agoraelectronics: { releaseCode: 'agoraElectronics:agoraElectronicsContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
            rootType: 'site', rootCode: 'agoraElectronicsSite', sourceVersion: '0' },
        agoratelco: { releaseCode: 'agoraTelco:agoraTelcoContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
