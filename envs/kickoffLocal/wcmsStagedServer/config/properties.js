...
module.exports = {
    ...
    data: { dataReleases: { lifecycleMetadataRequired: true, destinationEnforced: true, environmentClass: 'LOCAL',
        ...
        localDocumentationFoundation: { enabled: true,
    ...
    cms: { publication: {
        ...
        nexus: { releaseCode: 'nexus.web:nexusCorporateSite', releaseVersion: '0.0.8', dataType: 'sample',
            rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        nexusupdate: { releaseCode: 'nexus.web:nexusCorporateSiteUpdate', releaseVersion: '0.0.0', dataType: 'sample',
            rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        nexusecosystemrepair: { releaseCode: 'nexus.web:nexusCorporateEcosystemComponentRepair', releaseVersion: '0.0.0',
            dataType: 'sample', rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        nexusincremental: { releaseCode: 'nexus.web:nexusCorporateIncrementalProof', releaseVersion: '0.0.0',
            dataType: 'sample', rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        nexusprofessionalcopy: { releaseCode: 'nexus.web:nexusCorporateProfessionalCopyUpdate', releaseVersion: '0.0.0',
            dataType: 'sample', rootType: 'site', rootCode: 'nexusCorporateSite', sourceVersion: '0' },
        agoraapparel: { releaseCode: 'agora.apparel:agoraApparelContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
        ...
        agoratelco: { releaseCode: 'agora.telco:agoraTelcoContentCatalog', releaseVersion: '0.0.0', dataType: 'sample',
            rootType: 'site', rootCode: 'agoraTelcoSite', sourceVersion: '0' },
        frameworkdocs: { contentPackCode: 'nodicsDocumentation', releaseVersion: '0.16.7',
            rootType: 'site', rootCode: 'nodicsDocumentationSite', sourceVersion: '0' },
        axisdocs: { contentPackCode: 'axisDocumentation', releaseVersion: '0.0.1',
            rootType: 'site', rootCode: 'axisDocumentationSite', sourceVersion: '0' },
        kickoffdocs: { contentPackCode: 'kickoffDocumentation', releaseVersion: '0.0.1',
