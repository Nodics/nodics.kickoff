...
module.exports = {
    ...
    activeModules: {
        groups: [],
        modules: ['cmsStaged', 'nodics.kickoff', 'kickoffCore', 'kickoffApi', 'kickoffInt', 'nexus.web', 'partnerSiteData', ...agoraDomains.projectPacks,
    ...
    cms: { publication: {
        ...
        nexusupdate: { releaseCode: 'nexus.web:nexusCorporateSiteUpdate', releaseVersion: '0.0.0', dataType: 'core',
        ...
        frameworkdocs: { contentPackCode: 'nodicsDocumentation', releaseVersion: '0.16.2',
